...
import me.rayzr522.pearlborder.command.CommandPearlBorder;
import me.rayzr522.pearlborder.utils.MessageHandler;
 ...
 * @author Rayzr
 */
public class PearlBorder extends JavaPlugin {
    private static PearlBorder instance;
    private MessageHandler messages = new MessageHandler();

    /**
     * @return The current instance of PearlBorder.
     */
    public static PearlBorder getInstance() {
        return instance;
    }
    ...
    public void onEnable() {
        ...
        // Set up commands
        getCommand("pearlborder").setExecutor(new CommandPearlBorder(this));
    }
